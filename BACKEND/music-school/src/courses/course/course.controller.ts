...
export class CourseController {
  ...
  async addToCart(@Body() addToCartDto: { courseId: string; userId: string; quantity: number }) {
    return this.courseService.addToCart(addToCartDto.courseId, addToCartDto.userId, addToCartDto.quantity);
  }
