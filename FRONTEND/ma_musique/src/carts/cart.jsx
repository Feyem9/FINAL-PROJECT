...
const updateCartItems = (itemId, newQuantity) => {
 try {
  ...
  if (error)
    return (
      <div className="bg-red-50 text-red-600 p-4 rounded-lg border border-red-200 m-4">
        Erreur: {error}
      </div>
    );
  ...
  const startPayment = async () => {
    try {
      const response = await fetch(
        "http://localhost:3001/transaction/checkout",
        {
          method: "POST",
        }
      );
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="font-medium text-gray-800 min-w-max">
