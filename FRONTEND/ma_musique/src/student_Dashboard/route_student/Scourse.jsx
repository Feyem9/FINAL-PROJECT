  ...
  const handleEnrollCourse = async (course) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        alert(
          error.message ||
            "Erreur lors de l'inscription au cours. Veuillez réessayer."
        );
      }
    } finally {
      setLoading(false);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-8 text-center max-w-md">
            ...
            <p className="text-gray-600 mb-4">
              Ce cours n'a pas encore de contenu disponible.
            </p>
            <button
              onClick={onClose}
                ...
                <div className="w-full h-full">
                  <video
                    ...
                    onError={(e) => {
                      ...
                      if (
                        errorDiv &&
                        errorDiv.classList.contains("video-error")
                      ) {
                  ...
                  <div className="video-error hidden w-full h-96 bg-gray-100 items-center justify-center flex-col">
                    ...
                    <p className="text-sm text-gray-600 text-center mb-4">
                      La vidéo ne peut pas être lue. Vérifiez le chemin du
                      fichier ou les paramètres du serveur.
                      <br />
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Utilisez les contrôles pour naviguer dans la vidéo
                        </p>
                      </div>
                      <div className="flex space-x-2">
                        <button
                  ...
                  <div className="flex-1 bg-white border border-gray-300 rounded-lg overflow-hidden">
                    ...
                    <div className="w-full h-full hidden items-center justify-center flex-col p-8 bg-gray-50">
                      ...
                      <p className="text-sm text-gray-600 text-center mb-2">
                        Le PDF ne peut pas être affiché directement dans le
                        navigateur.
                      </p>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Utilisez les contrôles du PDF pour naviguer
                        </p>
                      </div>
                      <div className="flex space-x-2">
                        <a
                  ...
                  <div className="w-full max-w-md">
                    <div className="mb-6 text-center">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.816L4.9 14.2A1 1 0 014 13.4V6.6a1 1 0 01.9-.8l3.483-2.616z"
                          clipRule="evenodd"
                        />
                      </svg>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-xs text-gray-500">
                        Utilisez les contrôles audio pour écouter le contenu
                      </p>
                    </div>
                  </div>
                </div>
  ...
  const fetchYoutubeVideos = async (query) => {
    ...
    try {
      const response = await axios.get(
        `${databaseUri}/course/search-youtube?q=${encodeURIComponent(query)}`
      );
  ...
  const handleAddToCart = async (course) => {
    try {
      ...
      if (response.data.success) {
        ...
        toast.warning(
          response.data.message || "Ajout au panier avec avertissement"
        );
      }
    } catch (error) {
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Search for music tutorials on YouTube
              </p>
            </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  {course.courseContent && course.courseContent.lessons && (
                    <div className="text-center">
                      <p className="text-xs text-gray-500">
                        {course.courseContent.lessons.length} leçon
                        {course.courseContent.lessons.length > 1 ? "s" : ""}{" "}
                        disponible
                        {course.courseContent.lessons.length > 1 ? "s" : ""}
                      </p>
                    </div>
          ...
          {filteredYoutubeVideos.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-gray-500">
                Try searching for music tutorials on YouTube
              </p>
            </div>
          )}
        </div>
            ...
            .map((course) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <button className="w-full py-2 px-4 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-all">
                      Mark as Complete
                    </button>
                  </div>
                </div>
